package org.loklak.android.api.twitter;


import org.loklak.android.model.twitter.MediaUpload;
...
public interface TwitterMediaAPI {
     ...
     * {@link org.loklak.android.api.twitter.TwitterAPI#postTweet(String, String, Double, Double)}
     * method.
